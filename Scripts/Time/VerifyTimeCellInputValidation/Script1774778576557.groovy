...
/**
 * Verify Timesheet Time Input Validation
 *
 * Purpose:
 * - Log in as ESS user.
 * - Open a specific timesheet period.
 * - Add a project/activity row and enter invalid hours.
 * - Verify that there is error message and user cannot save sheet
 */
...
// ------------------------------
WebUI.setText(inputDayMon, invalidHours)
WebUI.verifyElementVisible(validationMessage)
WebUI.click(btnSave)
WebUI.sleep(1000)
WebUI.verifyElementVisible(btnSave)
